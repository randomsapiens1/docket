...
export function LifeEventsSection() {
  ...
  const t = {
    en: {
      heading: "Birth, Death, Marriage — Guidelines for everything",
    ...
    bn: {
      heading: "জন্ম, মৃত্যু, বিয়ে — সবকিছুর গাইডলাইন",
      subheading: "আপনার জীবনে সম্প্রতি কোন বড় ঘটনাটি ঘটেছে? নিচে খুঁজুন বা নির্বাচন করুন এবং আপনার প্রয়োজনীয় কাজের সম্পূর্ণ তালিকাটি দেখে নিন।",
      ...
      noMatchTitle: "সরাসরি কোনো মিল পাওয়া যায়নি",
      noMatchDesc: "আপনার অনুসন্ধান অনুযায়ী আমরা কোনো সরাসরি মিল পাইনি। দয়া করে নিচের মূল ঘটনাগুলোর একটি নির্বাচন করুন অথবা 'নিবন্ধন', 'জন্ম', 'বিয়ে' বা 'মৃত্যু' লিখে আবার খুঁজুন।",
      actionHeader: "আপনার কর্মপরিকল্পনা তালিকা",
      live: "লাইভ নির্দেশিকা",
      soon: "শীঘ্রই",
      progressTitle: "আপনার অগ্রগতি",
      tasksCompleted: "টি কাজ সম্পন্ন হয়েছে",
      historyTitle: "সম্পন্নকৃত কাজের লগ (সব ঘটনা)",
      historySubtitle: "আপনার সম্পন্ন করা সব কাজের একটি স্থায়ী রেকর্ড।",
        ...
        birth: {
          ...
          actions: [
            ...
            },
            {
              ...
              desc: "নিশ্চিত করুন যে বাবা/মায়ের এনআইডি এবং টিন প্রোফাইল আপডেট করা আছে, কারণ শিশুর জন্ম নিবন্ধন এবং স্কুলে ভর্তির সময় অভিভাবক যাচাইয়ে এটি প্রয়োজন হয়।",
              status: "Live",
              href: "/services/register-for-tin"
            },
            {
        ...
        marriage: {
          ...
          actions: [
            ...
            },
            {
              ...
              desc: "পারিবারিক ইমিগ্রেশন বা স্পাউস ভিসার আবেদন প্রস্তুত করুন। এর জন্য পররাষ্ট্র মন্ত্রণালয় (MoFA) দ্বারা কাবিননামা বা ম্যারেজ সার্টিফিকেট সত্যায়িত করা বাধ্যতামুলক।",
              status: "Soon",
              href: "#"
            },
            {
              title: "যৌথ সম্পত্তি ক্রয়ের জন্য টিন (TIN) রেজিস্ট্রেশন",
              desc: "স্বামী-স্ত্রী যৌথ নামে সম্পত্তি ক্রয়ের জন্য, যৌথ ব্যাংক হিসাব খোলার জন্য বা আয়করে স্পাউস ছাড় পাওয়ার জন্য টিন (TIN) নিবন্ধন সম্পন্ন করুন।",
              status: "Live",
              href: "/services/register-for-tin"
            }
          ]
        ...
        death: {
          ...
          actions: [
            ...
            },
            {
              ...
              desc: "মৃত ব্যক্তির বৈধ উত্তরাধিকারীদের তালিকা সংবলিত ওয়ারিশন সনদ সংগ্রহ করুন। এটি কাউন্সিলর বা ইউনিয়ন পরিষদ চেয়ারম্যান ইস্যু করে থাকেন।",
              status: "Soon",
              href: "#"
            },
            {
              title: "উত্তরাধিকার সূত্রে প্রাপ্ত জমির নামজারি (মিউটেশন)",
              desc: "মৃত ব্যক্তির রেখে যাওয়া জমি বা সম্পত্তির মালিকানা খতিয়ান আপনার নামে আপডেট করুন। এটি ছাড়া জমি বিক্রয়, হেবা/দান করা বা খাজনা প্রদান সম্ভব নয়।",
              status: "Live",
              href: "/services/land-mutation"
            },
            {
              title: "ব্যাংক অ্যাকাউন্ট ও নমিনি সংক্রান্ত দাবি নিষ্পত্তি",
              desc: "মৃত ব্যক্তির ব্যাংক অ্যাকাউন্ট বন্ধ করতে বা জমাকৃত টাকা উত্তোলন করতে ব্যাংক বরাবর আবেদন করুন। এর জন্য মৃত্যু সনদ, ওয়ারিশ সনদ ও উত্তরাধিকারীদের এনআইডি প্রয়োজন হবে।",
              status: "Soon",
              href: "#"
            }
          ]
          ...
          actions: [
            {
              ...
              desc: "অফিশিয়াল ইনকরপোরেশন সার্টিফিকেট পেতে আরজেএসসি (RJSC) এর মাধ্যমে আপনার কোম্পানি রেজিস্টার করুন।",
              status: "Live",
              href: "/services/incorporate-a-private-company"
            },
            {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    const directKeywords: Record<EventType, string[]> = {
      death: ['die', 'dead', 'death', 'passed away', 'father', 'mother', 'parent', 'inherit', 'warisan', 'succession', 'loss', 'loved one', 'মারা', 'মৃত্যু', 'উত্তরাধিকার', 'বাবা', 'মা', 'ওয়ারিশ', 'ওয়ারিশন', 'সনদ'],
      birth: ['baby', 'child', 'born', 'birth', 'kid', 'son', 'daughter', 'school', 'admission', 'জন্ম', 'সন্তান', 'বাচ্চা', 'শিশু', 'স্কুল', 'ভর্তি', 'ছেলে', 'মেয়ে'],
    ...
    eventIds.forEach(id => {
      directKeywords[id].forEach(kw => {
        if (q.includes(kw)) eventScores[id] += 15
      })
    })
  ...
  const eventColors: Record<EventType, { icon: string; ring: string; tag: string }> = {
    birth:    { icon: 'bg-sky-50 text-sky-500',      ring: 'ring-sky-200 bg-sky-50/50',    tag: 'bg-sky-100 text-sky-700' },
    marriage: { icon: 'bg-pink-50 text-pink-500',    ring: 'ring-pink-200 bg-pink-50/50',  tag: 'bg-pink-100 text-pink-700' },
    death:    { icon: 'bg-slate-100 text-slate-500', ring: 'ring-slate-200 bg-slate-50/50',tag: 'bg-slate-100 text-slate-600' },
    business: { icon: 'bg-emerald-50 text-emerald-600', ring: 'ring-emerald-200 bg-emerald-50/50', tag: 'bg-emerald-100 text-emerald-700' },
  }

  return (
    <section id="life-events" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50/60 border-t border-gray-100 relative z-10">
      <ScrollReveal animation="slide-up">
        <div className="max-w-7xl mx-auto space-y-8 sm:space-y-10">
          ...
          {/* Search Card */}
          <div className="bg-white rounded-2xl shadow-md ring-1 ring-black/8 p-6 sm:p-8 space-y-6">
            <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-3">
              <div className="flex-1 flex items-center bg-gray-50 rounded-xl ring-1 ring-black/8 focus-within:ring-2 focus-within:ring-primary/40 transition-all duration-200 px-4 gap-3">
                ...
                <input
                  ...
                  className="flex-1 py-3.5 bg-transparent text-gray-900 text-sm font-medium placeholder:text-gray-400 focus:outline-none"
                />
              </div>
              <button
                type="submit"
                ...
                {(['birth', 'marriage', 'death', 'business'] as EventType[]).map((type) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex items-start gap-3 p-4 rounded-xl ring-1 text-left transition-all duration-200 hover:shadow-md",
                        isSelected
                          ? `${colors.ring} ring-2 shadow-md`
          ...
          {activeEvent && (
            <div
              ref={resultsRef}
              className="bg-white rounded-2xl ring-1 ring-black/8 shadow-md p-6 sm:p-8 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300"
            >
              {/* Guide Header */}
              <div className="border-b border-gray-100 pb-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                <div className="space-y-1.5">
                  <span className={cn("text-[10px] font-semibold uppercase tracking-widest px-2.5 py-1 rounded-full", eventColors[activeEvent].tag)}>
                    {t.actionHeader}
                  </span>
                ...
                {t.events[activeEvent].actions.map((action, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={cn(
                        "rounded-xl ring-1 p-5 flex flex-col justify-between transition-all duration-200",
                        isChecked
                          ? "ring-green-200 bg-green-50/40"
                          : "ring-black/8 bg-white hover:shadow-sm hover:ring-primary/20"
                      )}
                    >
                      <div className="space-y-3">
                        <div className="flex justify-between items-start gap-3">
                          <div className="flex items-start gap-3 flex-1 min-w-0">
                            {isMounted ? (
                              <button
                                ...
                                className="shrink-0 mt-0.5 transition-transform duration-100 hover:scale-110 active:scale-95"
                          ...
                          <span className={cn(
                            "text-[10px] font-semibold uppercase px-2.5 py-0.5 rounded-full shrink-0",
                            isLive
                      ...
                      {isLive && (
                        <div className="pt-3 pl-8">
                          <Link
                            href={action.href}
                            className="inline-flex items-center gap-1 text-xs font-medium text-primary hover:gap-1.5 transition-all duration-150"
                          >
                            Explore Live Guide
          ...
          {isMounted && completedList.length > 0 && (
            <div className="bg-white rounded-2xl ring-1 ring-black/8 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
              {/* Header Bar */}
              <div className="bg-gray-900 text-white px-5 py-3.5 flex justify-between items-center">
                <div className="flex items-center gap-2.5">
                  <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
                  <span className="text-xs font-semibold">{t.historyTitle}</span>
                </div>
                <span className="text-[10px] font-mono text-gray-400">PERSISTENT_LOG</span>
              </div>

              {/* Log Body */}
              <div className="p-6 sm:p-8 space-y-5">
                <p className="text-xs text-gray-400 font-medium">{t.historySubtitle}</p>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {completedList.map((item) => (
                    <div
                      key={`${item.eventId}_${item.taskIndex}`}
                      className="rounded-xl ring-1 ring-black/8 bg-gray-50 p-4 flex items-start justify-between gap-3 hover:bg-gray-100/70 transition-colors"
                    >
                      <div className="space-y-1.5 min-w-0">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <span className={cn(
                            "text-[10px] font-semibold uppercase px-2 py-0.5 rounded-full",
                            eventColors[item.eventId].tag
                          )}>
                            {item.eventTitle}
                          </span>
                          <span className="text-[10px] font-semibold uppercase px-2 py-0.5 rounded-full bg-green-100 text-green-700">
                            {t.completedBadge}
                          </span>
                        </div>
                        <p className="text-sm font-medium text-gray-800 leading-snug" title={item.taskTitle}>
                          {item.taskTitle}
                        </p>
                        {item.isLive && (
                          <Link
                      ...
                      <button
                        ...
                        className="p-1.5 hover:bg-gray-200 rounded-lg text-gray-400 hover:text-gray-600 transition-all shrink-0"
                ...
                <div className="pt-3 border-t border-gray-100 flex justify-end">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full ring-1 ring-red-200 bg-white hover:bg-red-50 text-red-500 font-medium text-xs transition-all duration-150"
                  >
